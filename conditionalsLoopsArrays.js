...
let roster = ["Pikachu", "Mextwo", "Onix","Eevee"];
...
// "roster" array
let firstLast = roster.map(function(roster) {
...
let health = 100;
 console.log(`Health is at: ${health - attackDmg}`);
